...
> Source: https://man7.org/linux/man-pages/man3/isspace.3p.html
...
## SEE ALSO
isalnum(3p), isalpha(3p), isblank(3p), iscntrl(3p), isgraph(3p), islower(3p), isprint(3p), ispunct(3p), isupper(3p), isxdigit(3p), isspace(3p)
